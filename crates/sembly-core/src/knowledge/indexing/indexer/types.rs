...
pub enum IndexingError {
    ...
    #[diagnostic(
        code(sembly::indexing::scan_failed),
    ...
    #[diagnostic(
        code(sembly::indexing::chunking_failed),
    ...
    #[diagnostic(
        code(sembly::indexing::index_data_generation_failed),
    ...
    #[diagnostic(
        code(sembly::indexing::storage_failed),
