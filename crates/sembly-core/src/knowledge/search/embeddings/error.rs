...
pub enum EmbeddingError {
    ...
    #[diagnostic(
        code(sembly::embeddings::model_load_failed),
    ...
    #[diagnostic(
        code(sembly::embeddings::model_download_failed),
    ...
    #[diagnostic(
        code(sembly::embeddings::embedding_generation_failed),
    ...
    #[diagnostic(
        code(sembly::embeddings::dimension_mismatch),
    ...
    #[diagnostic(
        code(sembly::embeddings::cache_access_failed),
