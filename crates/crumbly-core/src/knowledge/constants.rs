...
//!
//! This module defines path constants for crumbly's directory structure
//! and configuration constants for embedding and indexing behavior.

// Path constants

/// The crumbly database directory name.
pub const SEMBLY_DIR: &str = ".crumbly";

/// The crumbly configuration file name.
pub const SEMBLY_CONFIG: &str = "crumbly.toml";

/// The crumbly ignore file name.
pub const SEMBLY_IGNORE: &str = ".crumblyignore";
