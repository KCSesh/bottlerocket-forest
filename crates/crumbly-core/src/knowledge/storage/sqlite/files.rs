...
use crate::knowledge::domain::{ContextId, FileHash, IndexRelativePath, IndexedFile};
        ...
        |row| {
            ...
            Ok(IndexedFile {
                context_id: ContextId::from_path(&context_id)
                    .map_err(|_| rusqlite::Error::InvalidQuery)?,
                file_path: IndexRelativePath::try_new(&file_path)
                    .map_err(|_| rusqlite::Error::InvalidQuery)?,
...
/// Removes an indexed file from a context.
pub fn remove_indexed_file_from_context(
    conn: &Connection,
    file_path: &IndexRelativePath,
    context_id: &ContextId,
) -> Result<usize, IndexedFileError> {
    ...
    let deleted = conn
        .execute(
            ...
            [context_id.as_str(), &file_path.to_string()],
        )
        .context(DatabaseSnafu)?;
...
mod test {
    ...
    fn indexed_file_creation_with_all_fields() {
        ...
        let file_path = IndexRelativePath::try_new("src/main.rs").unwrap();
    ...
    fn insert_and_retrieve_indexed_file() {
        ...
        let file_path = IndexRelativePath::try_new("docs/README.md").unwrap();
    ...
    fn lists_files_for_specific_context() {
        ...
        let file1 = IndexedFile::builder()
            ...
            .file_path(IndexRelativePath::try_new("file1.rs").unwrap())
        ...
        let file2 = IndexedFile::builder()
            .context_id(context_a.clone())
            .file_path(IndexRelativePath::try_new("file2.rs").unwrap())
        ...
        let file3 = IndexedFile::builder()
            ...
            .file_path(IndexRelativePath::try_new("file3.rs").unwrap())
    ...
    fn same_file_path_in_different_contexts_creates_separate_records() {
        ...
        let same_path = IndexRelativePath::try_new("src/lib.rs").unwrap();
