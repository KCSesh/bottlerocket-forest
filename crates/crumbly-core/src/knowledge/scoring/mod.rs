...
//!
//! ```no_run
//! use crumbly_core::knowledge::scoring::{ScoreBooster, default_boost_rules};
//! use crumbly_core::knowledge::domain::RelevanceScore;
//!
...
//! #         .file_path(IndexRelativePath::try_new("README.md")?)
