# Feature 0003: Crumbly CLI - Requirements Specification

## Overview

This specification defines the command-line interface for Crumbly, a semantic search tool for exploring documentation using ML embeddings. The CLI provides commands for building and managing knowledge indexes, performing semantic searches, and managing contexts within a workspace.

## Functional Requirements

### CLI-1: Build Command

WHEN the user invokes crumbly build  
...
WHEN the user invokes crumbly rebuild  
...
WHEN the user invokes crumbly update  
...
WHEN the user invokes crumbly clear  
...
WHEN the user invokes crumbly search <query>  
...
WHEN the user invokes crumbly status  
...
WHEN the user invokes crumbly context list  
...
WHEN the user invokes crumbly context remove <context_id>  
...
WHEN the user invokes crumbly gc  
...
THEN the system SHALL store the knowledge index in .crumbly/knowledge/ at the forest root
...
WHILE executing crumbly context remove  
...
WHILE executing crumbly search  
