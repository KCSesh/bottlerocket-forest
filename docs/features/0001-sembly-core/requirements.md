# Sembly Core - Requirements Specification

## Overview

This specification defines the functional and non-functional requirements for Sembly Core, a semantic search library for documentation in large codebases.
...
WHERE a .semblyignore file exists in a directory  
THEN the system SHALL respect .semblyignore patterns when discovering files
...
- Requirements use "SC" prefix (Sembly Core)
