...
Sembly Core will provide a semantic search library that understands the meaning of queries, not just keyword matches. By leveraging machine learning embeddings, the system will find relevant documentation even when queries use different terminology than the source material.
